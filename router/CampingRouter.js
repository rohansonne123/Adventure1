...
const Listing=require("../models/Camping.js")
const path=require("path");
const wrapAsync=require("../Utils/wrapAsync.js");
const {serverSide}=require("../Schema.js");
const router=express.Router();
const {isloggedin,isOwnerCamping}=require("../middleware.js");
const controllerListing=require("../controller/CampingController.js");
...
router.get("/search", wrapAsync(async (req, res) => {
    ...
    res.render("./Camping/list.ejs", { allListing: listings });
}));
...
//update route
router.get("/:id/edit",upload,isloggedin,isOwnerCamping,controllerListing.updateRoute)
router.put("/:id",upload,wrapAsync(controllerListing.updateput))

//delete listing
router.delete("/:id",isloggedin,isOwnerCamping,controllerListing.deleteRoute);
