...
const agrireviewController=require("../controller/agrireviewController.js");
...
router.post("/agrireview",isloggedin,wrapAsync(agrireviewController.agrireviewPost));
router.delete("/agrireview/:reviewId",isloggedin,isAuthor,wrapAsync(agrireviewController.agrireviewDelete));
...
router.post("/rooms/:roomid/review",isloggedin,wrapAsync(async(req,res,next)=>{
    ...
    await listing.save();
    req.flash("success","added review sucessfully");
    res.redirect(`/Agri/${id}/rooms/${roomid}`);
}))
