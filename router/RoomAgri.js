...
router.get("/search", wrapAsync(async (req, res) => {
    ...
    res.render("./HotelAgri/index.ejs", { alllist: listings });
}));
//add new route
router.get("/:id/rooms/new",isloggedin,wrapAsync(async(req,res,next)=>{
    ...
    res.render("./RoomAgri/add.ejs",{id});
...
router.get("/:id/rooms/:roomid/edit",upload,isloggedin,wrapAsync(async(req,res)=>{
    ...
    if(!listing){
        ...
        res.redirect(`/Agri/${id}/rooms`);

    }
    res.render("./RoomAgri/update.ejs",{id,listing,editImageUrl});
}))
...
router.get("/:id/rooms/:roomid",wrapAsync(async(req,res)=>{
    ...
    if(!list){
        ...
        res.render("./RoomAgri/show.ejs",{id,list,Orignlist});
...
router.get("/:id/rooms",wrapAsync(async(req,res)=>{
    ...
    console.log(alllist);
    //res.send();
   res.render("./RoomAgri/index.ejs",{list,id});
}) )
